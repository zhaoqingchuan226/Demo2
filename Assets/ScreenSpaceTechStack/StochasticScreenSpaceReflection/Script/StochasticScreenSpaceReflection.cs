...
public class StochasticScreenSpaceReflection : MonoBehaviour
{
    ...
    private Camera RenderCamera;//不用复制

    private CommandBuffer ScreenSpaceReflectionBuffer_ = null;//不用复制

    private CommandBuffer ScreenSpaceReflectionBuffer//不用复制
    {
        get
        {
...

    ...
    void OnEnable()
    {
        if (ScreenSpaceReflectionBuffer != null) {
            RenderCamera.AddCommandBuffer(CameraEvent.BeforeImageEffectsOpaque+1, ScreenSpaceReflectionBuffer);
        }
    }
    ...
    {
        if (ScreenSpaceReflectionBuffer != null) {
            RenderCamera.RemoveCommandBuffer(CameraEvent.BeforeImageEffectsOpaque+1, ScreenSpaceReflectionBuffer);
        }
    }
