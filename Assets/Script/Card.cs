...
public partial class Card
{
    ...
    public Card(Card card)
    {
        ...
        )
        {
            ...
            case 5:
                this.qualityColor =
                    new Color(255f / 255f, 194f / 255f, 50f / 255f, 1);
                break;
        }
    ...
    {
        if (AIMechanism.Instance.AIDatas.Count >= num)
        {
            return true;
        }
        else
    ...
    )
    {
        ...
        else//特殊的卡牌,>=20000
        {
            ...
            for (int i = 0; i < amount; i++)
            {
                ...
                {
                    AIData AIData_r = AIMechanism.Instance.AIDatas[Random.Range(0, AIMechanism.Instance.AIDatas.Count)];
